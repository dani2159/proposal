...
class ProposalController extends Controller
{
    ...
    {
        $data['menunggu'] = Proposal::where(['is_deleted' => 0, 'is_active' => 1, 'status' => 0])->count();
        $data['ditolak'] = Proposal::where(['is_deleted' => 0, 'is_active' => 1, 'status' => 2])->count();
        $data['disetujui'] = Proposal::where(['is_deleted' => 0, 'is_active' => 1, 'status' => 1])->count();
        $data['ormawa'] = Ormawa::where(['is_deleted' => 0])->count();
    ...
    public function detail($id)
    {
        ...
        return view('Admin.detail-proposal', $data);
    }
