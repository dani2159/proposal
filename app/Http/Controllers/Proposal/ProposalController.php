...
class ProposalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Proposal.home', compact('var_nama'));
    }

    public function proposal1()
    {
        $data=Proposal::select('pengajuan_ormawa.*','ormawa.*')
        ->leftjoin('ormawa','pengajuan_ormawa.ormawa_id','=', 'ormawa.id')
        ->get();
        return view ('Proposal.proposal1', compact('data'));
    }
    public function proposal2()
    {
        $var_nama = "SyehBiaggie ";
        return view ('Proposal.proposal2', compact('var_nama'));
    }
    public function proposal3()
    {
        $var_nama = "SyehBiaggie ";
        return view ('Proposal.proposal3', compact('var_nama'));
    }
    public function pengumuman()
    {
        $var_nama = "SyehBiaggie ";
        return view ('Proposal.pengumuman', compact('var_nama'));
    }
