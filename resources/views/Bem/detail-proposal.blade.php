            ...
            @if ($item->status == 0)
                <div class="card-footer">
                    <div class="float-right">
                        <button class="btn btn-danger" data-toggle="modal" data-target="#rejectModal"><span class="fa fa-times"></span> Tolak</button>
                        <button class="btn btn-success" onclick="terima({{ $item->id }})"><span class="fa fa-check"></span> Terima</button>
                    </div>
                </div>
            @endif
        </div>
